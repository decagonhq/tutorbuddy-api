    ...
    public partial class initialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilityTutor", x => new { x.AvailabilityID, x.TutorUserId });
                    table.ForeignKey(
                        name: "FK_AvailabilityTutor_Availabilities_AvailabilityID",
                        column: x => x.AvailabilityID,
                        principalTable: "Availabilities",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AvailabilityTutor_Tutor_TutorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TutorSubjects_Subjects_SubjectsID",
                        column: x => x.SubjectsID,
                        principalTable: "Subjects",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TutorSubjects_Tutor_TutorUserId",
                        column: x => x.TutorUserId,
                        principalTable: "Tutor",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityTutor_TutorUserId",
                table: "AvailabilityTutor",
                column: "TutorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorSubjects_SubjectsID",
                table: "TutorSubjects",
                column: "SubjectsID");

            migrationBuilder.CreateIndex(
                name: "IX_TutorSubjects_TutorUserId",
                table: "TutorSubjects",
                column: "TutorUserId");
        }
